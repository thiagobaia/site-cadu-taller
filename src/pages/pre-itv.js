      ...
      <div>
        ...
        <div className="flex justify-center flex-col items-center w-full">
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center md:justify-start md:items-stretch md:flex-row md:flex-wrap lg:justify-start lg:flex-row lg:items-stretch lg:flex-wrap gap-2.5 py-12">
        ...
        <div className="flex flex-col justify-center items-center w-full">
          ...
          >
            <img
              ...
              alt=""
            />
            <p className="mb-4 text-4xl px-2.5 font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl text-center">
            ...
            <p className="mb-6 text-lg text-center font-normal text-white lg:text-xl sm:px-16 xl:px-48 px-5">
              ...
              emisiones y suspensión. Identificaremos y repararemos todo antes
              de que el inspector lo detecte.
            </p>
            <a
              href="/contact"
        ...
        >
          ...
          <figure className="max-w-3xl mx-auto text-center">
            ...
            <blockquote>
              <p className="text-xl lg:text-2xl italic font-medium text-gray-900 px-5">
            ...
            <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse px-8">
              ...
              <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500">
                <cite className="pe-3 text-xs lg:text-2xl font-medium text-gray-900">
                  Jose Padron Hernández
                </cite>
                <cite className="ps-3 text-sm lg:text-2xl text-gray-500">
                  Opinión del cliente
                </cite>
              </div>
            </figcaption>
